...
export const PrimaryPencil = () => <Icon name="pencil" size={18} color="#716AFF" />;
export const WhiteTrash = () => <Icon name="trash" size={24} color="#F4F4F4" />;
export const Trash = () => <Icon name="trash" size={24} color="#716AFF" />;
